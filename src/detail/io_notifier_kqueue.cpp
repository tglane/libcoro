...
auto io_notifier_kqueue::event_to_poll_status(const event_t& event) -> poll_status
{
    ...
    // std::cout << "Write filter: " << std::bitset<32>(EVFILT_WRITE) << std::endl;
    // std::cout << "Read filter: " << std::bitset<32>(EVFILT_READ) << std::endl;
    // std::cout << "filter: " << std::bitset<32>(event.filter) << std::endl;
    std::cout << "Write filter: " << EVFILT_WRITE << std::endl;
    std::cout << "Read filter: " << EVFILT_READ << std::endl;
    std::cout << "filter: " << event.filter << std::endl;

    // std::cout << "Eof flag: " << std::bitset<32>(EV_EOF) << std::endl;
    // std::cout << "Error flag: " << std::bitset<32>(EV_ERROR) << std::endl;
    // std::cout << "flags: " << std::bitset<32>(event.flags) << std::endl;
    std::cout << "Eof flag: " << EV_EOF << std::endl;
    std::cout << "Error flag: " << EV_ERROR << std::endl;
